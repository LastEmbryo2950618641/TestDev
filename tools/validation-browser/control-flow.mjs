...
const result = await page.evaluate(async () => {
  ...
  return {
    ...
    hasWechatMentionInputHelper: typeof window.GameModules.app?.wechat?.mentionInputHelper?.insertWechatMention === 'function',
    ...
    hasWechatImageReceiveOrchestration: typeof window.GameModules.app?.wechat?.imageReceiveOrchestration?.confirmWechatImageReceive === 'function',
    hasWechatImageOfferOrchestration: typeof window.GameModules.app?.wechat?.imageOfferOrchestration?.appendWechatPendingImageMessage === 'function',
