...
assert.strictEqual(api.isValidProfileFormat('中华人民共和国·四川省·成都市·武侯区·锦苑小区3栋·2单元202'), true);
assert.strictEqual(api.isValidProfileFormat('中华人民共和国・四川省・成都市・武侯区・锦苑小区3栋・2单元601'), true);
...
assert.strictEqual(
  api.isValidProfileFormat('中华人民共和国·四川省·成都市·武侯区·锦苑小区3栋·2单元601号'),
  true,
);
...
assert.strictEqual(
  api.isRecordedLocation('中华人民共和国·四川省·成都市·武侯区·锦苑小区3栋·2单元601号'),
  true,
);
...
assert.strictEqual(api.mapNodeName('中华人民共和国·四川省·成都市·武侯区·锦苑小区3栋·2单元202'), '锦苑小区3栋');
assert.strictEqual(api.mapNodeName('中华人民共和国·四川省·成都市·武侯区·锦苑小区3栋·2单元601室'), '锦苑小区3栋');
assert.strictEqual(api.interiorPosition('中华人民共和国·四川省·成都市·武侯区·锦苑小区3栋·2单元202'), '2单元202');
assert.strictEqual(api.interiorPosition('中华人民共和国·四川省·成都市·武侯区·锦苑小区3栋·2单元601室'), '2单元601室');
assert.strictEqual(
  api.interiorPosition('中华人民共和国·四川省·成都市·武侯区·锦苑小区3栋·2单元601室内楼梯上第一间房间床上'),
  '2单元601室内楼梯上第一间房间床上',
);
assert.strictEqual(
  api.mapNodeName('中华人民共和国·四川省·成都市·武侯区·锦苑小区3栋·2单元601室内楼梯上第一间房间床上'),
  '锦苑小区3栋',
);
assert.strictEqual(api.isValidProfileFormat('中华人民共和国·四川省·成都市·武侯区·锦苑小区3栋·2单元601室内楼梯上第一间房间床上'), true);
...
const state = api.stateValueFromText('中华人民共和国·四川省·成都市·武侯区·锦苑小区3栋·2单元202', null, 'test');
assert.strictEqual(state.name, '锦苑小区3栋');
assert.strictEqual(state.currentLocation, '中华人民共和国·四川省·成都市·武侯区·锦苑小区3栋·2单元202');
