...
window.GameModules.updateRegistry?.registerPrompt?.('sexual-experience-update', `# sexual-experience-update
...
- partKey 支持：genital（阴部）、chest（胸部）、lips（嘴唇）、mouth（口部）、anus（肛门）、legs（腿部）、hips（臀部）、hands（手部）、skin（皮肤接触）、other（其他）。
