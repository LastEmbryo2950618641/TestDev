...
- 必须从输入信息中提取人物特征并翻译成英文标签，至少包含 6 个个性化标签。
- 个性化标签优先来自：发色、发型/发长、眼睛、脸型/表情、身材、身高体型、肤色、气质、服装/身体部位特征。
- 不要只返回固定画面要求；如果只有 1girl、solo、full body、standing、front view 这类构图词，就是不合格。
- 先写最重要的内容。
