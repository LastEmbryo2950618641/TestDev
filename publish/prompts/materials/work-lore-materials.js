...
window.GameModules.workLoreMaterials = {
  items: [
    ...
    { id: 'past-event-search', title: '统一查询过去事件', size: 'large', maxChars: 5200, skill: 'past.event.query', method: 'searchPastEvent', paramsHint: { world: '世界名/作品名', question: '用户问题', keywords: ['角色名', '事件词', '地点或时间'], characterName: '角色名', timeHint: '几天前/昨天/某日期' }, when: '玩家询问几天前、之前、上次、记不记得、旧承诺、图片、地点、物品或角色过去经历。' },
