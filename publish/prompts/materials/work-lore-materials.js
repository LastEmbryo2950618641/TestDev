...
window.GameModules.workLoreMaterials = {
  items: [
    ...
    { id: 'work-people', title: '人物索引/人物卡查询', size: 'large', maxChars: 1800, skill: 'worklore.query', method: 'searchPeople', paramsHint: { world: '世界名/作品名', keyword: '人物名或称号' }, when: 'Stage1 请求：type=作品设定查询；action=搜索人物；params 按人物名或称号、作品名填写。行动涉及原作人物、身份、性格、当前阶段时查询；必须遵守 canon 和当前时间线，不得提前使用后期情报。' },
    ...
    { id: 'work-timeline', title: '时间线索引查询', size: 'large', maxChars: 1800, skill: 'worklore.query', method: 'searchTimeline', paramsHint: { world: '世界名/作品名', keyword: '时间/日期/阶段' }, when: 'Stage1 请求：type=作品设定查询；action=搜索时间线；params 按时间或阶段关键词、作品名填写。行动需要按当前时间线限制资料，遵守 canon，避免剧透或后期信息提前。' },
    ...
    { id: 'work-location', title: '地点资料查询', size: 'large', maxChars: 1600, skill: 'worklore.query', method: 'searchLocation', paramsHint: { world: '世界名/作品名', keyword: '地点名' }, when: 'Stage1 请求：type=作品设定查询；action=搜索地点；params 按地点名、作品名填写。行动发生在原作地点或需要地点规则时查询；地点锚定必须遵守 canon 和当前时间线。' },
