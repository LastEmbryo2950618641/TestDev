...
window.GameModules.workLoreMaterials = {
  items: [
    { id: 'character-profile-search', title: '查询角色完整身份资料', size: 'medium', maxChars: 0, skill: 'character.query', method: 'searchCharacterProfile', paramsHint: { world: '世界名/作品名', name: '角色名' }, when: '正文涉及某个具体人物，需先确认完整角色卡、身份、关系、状态、穿着和物品。角色卡整卡放行，不截断长度。' },
