...
window.GameModules.realWorldMaterials = {
  items: [
    ...
    { id: 'faction-create', title: '创建完整势力', size: 'medium', maxChars: 1600, skill: 'faction.query', method: 'createFaction', stage1Policy: 'allow', paramsHint: { id: '势力ID', name: '势力名', type: '类型', worldTag: '所属世界', structure: [], solid: {}, reason: '依据' }, when: 'Stage1：上下文出现现实势力但列表未收录时创建；正文后 Stage8 也可创建。须尽量补全已知字段。' },
