...
window.GameModules.realWorldMaterials = {
  items: [
    ...
    { id: 'current-location', title: '当前地点上下文', size: 'small', maxChars: 1200, skill: 'realworld.location.query', method: 'getCurrentLocationContext', paramsHint: { world: '世界名',}, when: '确认玩家现在所在地点、上级地点、子地点和说明。' },
    ...
    { id: 'nearby-locations', title: '附近地点', size: 'small', maxChars: 900, skill: 'realworld.location.query', method: 'getNearbyLocations', paramsHint: { world: '世界名', locationName: '当前或目标地点名' }, when: '判断周围、同级地点或上下级地点。' },
    ...
    { id: 'worldline-time-search', title: '按时间查询世界线资料', size: 'medium', maxChars: 1800, skill: 'realworld.history.query', method: 'searchWorldlineByTime', paramsHint: { world: '世界名', time: '日期、时间段或时间关键词' }, when: '需要根据发生时间、当天、昨天、某月某日等线索加载具体世界线资料。' },
