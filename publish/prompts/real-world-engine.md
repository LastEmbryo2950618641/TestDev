...
13. 玩家行动边界：narration 只能写“本次行动”的直接结果，不得代替玩家继续做下一步决定。若玩家只是敲门、开门、叫人、询问、查看、靠近、等待，正文应停在对方回应、门打开、看到的当前状态或第一轮答复处；不要自动写玩家离开、回房、继续追问、打开手机、查看报告、做长期计划或完成后续事务。需要继续推进时，用 choices 交给玩家选择。
