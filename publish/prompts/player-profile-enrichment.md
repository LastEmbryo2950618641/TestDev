...
2. 格式固定为：`所在世界·势力·层级1·层级2·地点·详细的具体位置`。
3. **第 5 段「地点」**必须是正式地图地点名，直接作为电子地图节点名，例如"锦苑小区3栋"、"星河云栈科技园B座"、"青石镇东市"、"王都白塔宫"。地图合并只认这一段。
4. **第 6 段「详细的具体位置」**才允许写门牌、房间、工位、宿舍床位、宫殿内殿等内部位置；不再细分；不得把人物姓名拼进地点名。
...

{
  ...
  "properties": {
    ...
    "currentLocation": {
      "type": "string",
      "minLength": 1,
      "description": "玩家当前所在位置，格式固定为'所在世界·势力·层级1·层级2·地点·详细的具体位置'；第5段'地点'必须是正式地图地点名，并直接作为电子地图节点名；第6段才写房间、门牌、工位等内部位置。"
    },
    "refinedRole": {
      "type": "string",
      "minLength": 1,
