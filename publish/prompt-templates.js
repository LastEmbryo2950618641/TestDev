...
window.GameModules.promptTemplates = {
  items: [
    ...
    { id: 'character-profile-part2-feeling', title: '角色卡 Part2 情绪数值', category: '角色生成', file: 'prompts/character-profile-part2-feeling.md', summary: '按预定义 JSON 生成情绪数值。' },
    { id: 'character-profile-part3-player-feelings', title: '角色卡 Part3 对玩家感觉', category: '角色生成', file: 'prompts/character-profile-part3-player-feelings.md', summary: '按预定义 JSON 生成对玩家感觉。' },
    { id: 'character-profile-part4-abilities-professions', title: '角色卡 Part4 能力职业', category: '角色生成', file: 'prompts/character-profile-part4-abilities-professions.md', summary: '按预定义 JSON 生成技能、知识与职业。' },
    { id: 'character-profile-part5-inventory-wearing-rpg', title: '角色卡 Part5 物品属性', category: '角色生成', file: 'prompts/character-profile-part5-inventory-wearing-rpg.md', summary: '按预定义 JSON 生成装备、物品、穿着与 RPG 属性。' },
