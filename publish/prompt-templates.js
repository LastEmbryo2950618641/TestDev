...
window.GameModules.promptTemplates = {
  items: [
    ...
    { id: 'character-profile-part1-base-identity', title: '角色卡 Part1 基础身份', category: '角色生成', file: 'prompts/character-profile-part1-base-identity.md', summary: '按预定义 JSON 生成基础身份、社会关系与情感系统。' },
    { id: 'character-profile-part2-abilities-professions', title: '角色卡 Part2 能力职业', category: '角色生成', file: 'prompts/character-profile-part2-abilities-professions.md', summary: '按预定义 JSON 生成技能、知识与职业。' },
    { id: 'character-profile-part3-inventory-wearing-rpg', title: '角色卡 Part3 物品属性', category: '角色生成', file: 'prompts/character-profile-part3-inventory-wearing-rpg.md', summary: '按预定义 JSON 生成装备、物品、穿着与 RPG 属性。' },
