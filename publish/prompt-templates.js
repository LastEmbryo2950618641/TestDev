...
window.GameModules.promptTemplates = {
  items: [
    ...
    { id: 'character-profile-part6-rpg-field', title: '角色卡 Part6 RPG属性', category: '角色生成', file: 'prompts/character-profile-part6-rpg-field.md', summary: '按预定义 JSON 生成 RPG 属性。' },
