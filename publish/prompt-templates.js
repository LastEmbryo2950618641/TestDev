...
window.GameModules.promptTemplates = {
  ...
  items: [
    ...
    { id: 'inference-stage11-world-news-update', title: 'Stage12 世界新闻热榜', category: '剧情推演', file: 'prompts/推演引擎/stage11-world-news-update.md', summary: '按正文与时间推进调整世界新闻热榜。' },
    ...
    { id: 'inference-update-faction-structure', title: '遗留：势力结构更新', category: '结算更新', file: 'prompts/推演引擎/update/faction-structure-update-prompt.md', summary: '遗留结算说明；现由 Stage9 Skill 写库。' },
    { id: 'inference-update-org-overview-panel', title: '遗留：组织五面板更新', category: '结算更新', file: 'prompts/推演引擎/update/org-overview-panel-update-prompt.md', summary: '遗留结算说明；现由 Stage9 Skill 写库。' },
    ...
    { id: 'inference-update-faction-overview', title: '遗留：势力总览更新', category: '结算更新', file: 'prompts/推演引擎/update/faction-overview-update-prompt.md', summary: '遗留结算说明；现由 Stage9 Skill 写库。' },
    { id: 'inference-update-map', title: 'Stage10 地图更新', category: '结算更新', file: 'prompts/推演引擎/update/map-update-prompt.md', summary: 'Stage10 地图与地点事实更新说明。' },
