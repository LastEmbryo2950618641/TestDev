...
window.GameModules.createSystemPrompt = async function createSystemPrompt(state, action) {
  ...
  const outputJson = JSON.stringify({
    ...
    lexiconUpdates: [{ worldTag: character.work || '原创世界', kind: '装备/物品/穿着/状态/角色卡/角色技能', field: '角色卡字段名', name: '词条名或skills', value: { name: '技能名', desc: '技能说明', description: '说明', equipSlots: ['装备'], slot: '装备' }, summary: '摘要', description: '说明', reason: '为什么本回合必须修改或新增该词条' }],
  });
