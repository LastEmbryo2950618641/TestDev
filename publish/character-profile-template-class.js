...
window.GameModules.characterProfileTemplateClass = {
  ...
  wearingObject() {
    return {
      ...
      innerwearTop: this.wearSlot('内衣', '日常内衣', '符合当前人物身份和场景的内衣。', '内衣由日常生活和身体遮蔽需要决定。'),
      top: this.wearSlot('上衣', '日常上衣', '符合当前人物身份和场景的上衣。', '上衣由当前生活场景和人物习惯决定。'),
      outerwear: this.wearSlot('外套'),
      gloves: this.wearSlot('手套'),
      waist: this.wearSlot('腰部'),
      innerwearBottom: this.wearSlot('内衣', '日常内裤', '符合当前人物身份和场景的内裤。', '内裤由日常生活和身体遮蔽需要决定。'),
      bottom: this.wearSlot('下装', '日常下装', '符合当前人物身份和场景的下装。', '下衣由当前生活场景和行动需要决定。'),
      socks: this.wearSlot('袜子', '日常袜子', '适合当前鞋履和场景的袜子。', '袜子由出行方式和穿鞋需要决定。'),
      shoes: this.wearSlot('鞋子', '日常鞋履', '适合当前行动环境的鞋履。', '鞋履由出行方式和行动场景决定。'),
