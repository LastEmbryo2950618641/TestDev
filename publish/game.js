...
function registerGameStore() {
  ...
  const modules = [
    gm.actions, gm.rpgFieldUi, gm.resultActions, gm.loadingActions, gm.roleCardLoadingActions, gm.saveActions, gm.styleActions,
  ...
  Alpine.store('game', {
    ...
    roleCardLoadingState: { open: false, expanded: true, cards: [], startedAt: 0 },
