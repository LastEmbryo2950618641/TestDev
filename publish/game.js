...
function registerGameStore() {
  ...
  Alpine.store('game', {
    ...
    characterCardConfirm: window.GameModules.characterCardConfirm.state(),
    ...
    rpgStates: {},
    rpgPanelCharacterId: '',
    characterCardGenerationAllowed: null,
    rpgPrepareToken: 0,
