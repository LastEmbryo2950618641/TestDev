...
document.addEventListener('alpine:init', () => {
  ...
  Alpine.store('game', {
    ...
    busy: false, started: false, desktopUnlocked: false, entrySetupOpen: false, identityAppOpen: false, wechatAppOpen: false, identityTargetId: 'player-self', wechatSelectedContact: 'player-self', wechatTab: 'chats', wechatView: 'home', wechatInput: '', wechatUsers: [], wechatAddName: '', wechatAddRelation: '',
    initPromise: null, phoneSetupDone: false, phoneActivationChoice: '', profileSetupBusy: false, phoneFixedTime: 0, phoneClockTimer: null,
