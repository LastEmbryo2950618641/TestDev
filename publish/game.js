...
document.addEventListener('alpine:init', () => {
  ...
  Alpine.store('game', {
    ...
    busy: false, started: false, desktopUnlocked: false, appHasOpened: false, appClosing: false, appSwitcherOpen: false, entrySetupOpen: false, identityAppOpen: false, wechatAppOpen: false, identityTargetId: 'player-self', wechatSelectedContact: 'player-self', appDragStartY: 0, appDragY: 0, appDragPeakY: 0, appGestureFromHomeZone: false, appGesturePointerId: null, appDragging: false,
    ...
    playerProfile: { name: '', gender: '', birthday: '', age: '', city: '', refinedCity: '', dailyRole: '', refinedRole: '', livingStatus: '', refinedLivingStatus: '', relationships: '', parents: '', parentStatus: '', parentDeathCause: '', worldbuildingNote: '', notes: '', profileEnrichedAt: '', initializedAt: '' }, playerName: '',
