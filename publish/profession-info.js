...
window.GameModules.professionInfo = {
  ...
  async ensure(worldTag, name, context = {}) {
    ...
    await window.GameModules.rpgLexicon.save(worldTag, '职业', info.name, { summary: info.summary, description: info.description, aiGenerated: true, related: [...info.intrinsicStats, ...info.learnedAbilities, ...info.worldAbilities], meta: { info }, source: 'ai' });
    return info;
  },
