...
window.GameModules.promptTemplates = {
  ...
  items: [
    ...
    { id: 'inference-update-generic', title: '???? Update ?????', category: '结算更新', file: 'prompts/推演引擎/update/generic-update-prompt.md', summary: 'Stage4 通用固化更新 skill 说明。' },
    ...
    { id: 'inference-update-faction-structure', title: '推演引擎 Update 势力结构', category: '结算更新', file: 'prompts/推演引擎/update/faction-structure-update-prompt.md', summary: 'Stage4 势力组织结构更新 skill 说明。' },    { id: 'inference-update-org-overview-panel', title: '\u63a8\u6f14\u5f15\u64ce Update \u7ec4\u7ec7\u4e94\u9762\u677f', category: '\u7ed3\u7b97\u66f4\u65b0', file: 'prompts/\u63a8\u6f14\u5f15\u64ce/update/org-overview-panel-update-prompt.md', summary: 'Stage4 \u52bf\u529b/\u793e\u7fa4\u4e94\u5927\u603b\u89c8\u9762\u677f\u4e8b\u5b9e\u66f4\u65b0\u8bf4\u660e\u3002' },
