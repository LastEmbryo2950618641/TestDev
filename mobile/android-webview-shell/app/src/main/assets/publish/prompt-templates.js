...
window.GameModules.promptTemplates = {
  ...
  items: [
    ...
    { id: 'inference-stage5-intro-card-update', title: 'Stage5 介绍卡更新', category: '剧情推演', file: 'prompts/推演引擎/stage5-intro-card-update.md', summary: '同步本轮新出现人物/存在的介绍卡。' },
    { id: 'inference-stage5-profile-gate', title: 'Stage6 外观判定', category: '剧情推演', file: 'prompts/推演引擎/stage5-profile-gate.md', summary: '判断自然/盛装外观是否需局部更新。' },
    { id: 'inference-stage5-body-profile-patch', title: 'Stage7 自然外观补丁', category: '剧情推演', file: 'prompts/推演引擎/stage5-body-profile-patch.md', summary: '局部重写 Part5 bodyProfileMeta/bodyProfile。' },
    { id: 'inference-stage5-dressed-profile-patch', title: 'Stage8 盛装外观补丁', category: '剧情推演', file: 'prompts/推演引擎/stage5-dressed-profile-patch.md', summary: '局部重写 Part6 dressedProfileMeta/dressedProfile。' },
    { id: 'inference-stage9-faction-create', title: 'Stage9-1 势力完整创建', category: '剧情推演', file: 'prompts/推演引擎/stage9-1-faction-create.md', summary: '根据完整上下文批量创建并补全势力。' },
    { id: 'inference-stage9-faction-update', title: 'Stage9-2 势力字段更新', category: '剧情推演', file: 'prompts/推演引擎/stage9-2-faction-update.md', summary: '补齐不合理字段或按事实变化更新势力。' },
    ...
    { id: 'inference-stage13-career-update', title: 'Stage13 职业生涯', category: '剧情推演', file: 'prompts/推演引擎/stage13-career-update.md', summary: '正文后创建/更新职业生涯、上班状态、绩效评价与贡献价值。' },
    { id: 'freelance-candidates', title: '自由职业候选生成', category: '职业生涯', file: 'prompts/freelance-candidates.md', summary: '根据玩家输入、当前世界与玩家资料生成自由职业者候选。' },
    ...
    { id: 'real-world-map-surround-unlock', title: 'Stage10 电子地图周围解锁', category: '剧情推演', file: 'prompts/real-world-map-surround-unlock.md', summary: '独立阶段：首次抵达且无侧向邻点时解锁周围一圈。' },
    ...
    { id: 'character-profile-part8-social-drive', title: '角色卡 Part8 社交驱动', category: '角色生成', file: 'prompts/character-profile-part8-social-drive.md', summary: '独立生成 socialDrive（关系门闩、正式事务、三条非必做想法与可达渠道），不并入 Part1–7。' },
    ...
    { id: 'wechat-behavior-short', title: '微信往来后人物行为短推演', category: '微信', file: 'prompts/wechat-behavior-short.md', summary: '微信回复后，短推演联系人当场在现实中的行为与处境。' },
