...
window.GameModules.characterReasonFallback = {
  ...
  rpgReasons(profile = {}, attrs = null) {
    ...
    const map = {
      ...
      charisma: has(/漂亮|可爱|清秀|俊|美|帅|貌|颜|长相|外形|外貌|五官|气质|偶像|模特/)
        ? `${name}的容貌、外形或气质在资料中有明确描述，魅力应同时反映长相吸引力与社交印象。`
        : has(/社交|管理|亲密|服务|领导|家庭/)
          ? `${name}的关系或社会角色需要沟通协调，因此魅力有现实支撑。`
          : `${name}的魅力综合容貌印象与日常社交表现；若无外貌突出描述则按普通人际水平固化。`,
