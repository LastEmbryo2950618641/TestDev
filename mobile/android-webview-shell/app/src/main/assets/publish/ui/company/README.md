...
- 内部只转发到 `company-pay-view-helpers.js`、`company-field-view-helpers.js`、`company-field-section-view-helpers.js`、`company-attendance-view-helpers.js`、`company-summary-view-helpers.js`、`company-organization-view-helpers.js`、`company-contract-view-helpers.js`、`company-employment-record-view-helpers.js`
