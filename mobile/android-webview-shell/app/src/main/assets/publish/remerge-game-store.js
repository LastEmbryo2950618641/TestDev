...
window.GameModules.remergeGameStore = function remergeGameStore() {
  ...
  const modules = [
    ...
    gm.factionActions, gm.factionArchiveActions, gm.factionOrgActions, gm.factionAiActions, gm.factionMembershipActions, gm.skillsActions, gm.knownProfessionActions, gm.characterRosterActions,
